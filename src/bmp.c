...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/01 10:31:59 by wsallei           #+#    #+#             */
/*   Updated: 2020/11/01 10:32:04 by wsallei          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int		ft_put(t_all *settings, int i, int j, int k)
{
	...
	while (r >= 0)
	{
		...
		settings->w.adr[j + (i * settings->dr.sl)] =
			settings->w.adr[k - r + (i * settings->dr.sl - 1)];
